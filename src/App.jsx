...
const CARNET_I18N = {
  fr: {
    ...
    emotionLow:"Calme", emotionHigh:"Survolté", plombPrefix:"Plomb", chevrotine:"Chevrotine", balle:"Balle", plombMax3:"Jusqu'à 3 numéros de plomb.", diffLow:"Très facile", diffHigh:"Quel tir !",
  ...
  nl: {
    ...
    emotionLow:"Kalm", emotionHigh:"Opgewonden", plombPrefix:"Lood", chevrotine:"Grof lood", balle:"Kogel", plombMax3:"Tot 3 loodnummers.", diffLow:"Heel makkelijk", diffHigh:"Wat een schot!",
  ...
  de: {
    ...
    emotionLow:"Ruhig", emotionHigh:"Aufgedreht", plombPrefix:"Schrot", chevrotine:"Rehposten", balle:"Flintenlaufgeschoss", plombMax3:"Bis zu 3 Schrotgrößen.", diffLow:"Sehr leicht", diffHigh:"Was für ein Schuss!",
  ...
  en: {
    ...
    emotionLow:"Calm", emotionHigh:"Wired", plombPrefix:"Shot", chevrotine:"Buckshot", balle:"Slug", plombMax3:"Up to 3 shot sizes.", diffLow:"Very easy", diffHigh:"What a shot!",
...
const TIER_MODAL_I18N = {
  ...
  nl: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles wat in Premium is inbegrepen", "Vergelijker tot 4 munities (3 in Premium)", "PDF-seizoensrapport (statistieken + detail van de vangsten)", "Favoriete munities — snelle toegang in de hele app", "150 AI-credits / maand in plaats van 100", "Antwoorden op Claude Opus — diepgaandere analyses", "Cloudsynchronisatie tussen je toestellen (binnenkort beschikbaar)"],
  ...
  de: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles, was in Premium enthalten ist", "Vergleich mit bis zu 4 Munitionen (3 in Premium)", "Saisonbericht PDF (Statistiken + Detail der Abschüsse)", "Lieblingsmunition — schneller Zugriff in der ganzen App", "150 KI-Credits / Monat statt 100", "Antworten auf Claude Opus — vertiefte Analysen", "Cloud-Synchronisierung zwischen deinen Geräten (bald verfügbar)"],
  ...
  en: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Everything included in Premium", "Comparator with up to 4 ammunitions (3 in Premium)", "Season report PDF (statistics + detailed harvest log)", "Favorite ammunitions — quick access throughout the app", "150 AI credits / month instead of 100", "Answers on Claude Opus — more in-depth analysis", "Cloud sync across your devices (coming soon)"],
                            ...
                            {FUSIL_CALIBRES.some(c => c.value === carnetDraft.calibre) ? (
                              <>
                                ...
                                <div style={{ display:"flex", flexWrap:"wrap", gap:6 }}>
                                  {[...PLOMB_NUMEROS.map(num => `${CN.plombPrefix} ${num}`), CN.chevrotine, CN.balle].map(opt => {
