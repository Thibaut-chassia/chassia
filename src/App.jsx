...
const TIER_MODAL_I18N = {
  ...
  nl: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles wat in Premium is inbegrepen", "Vergelijker tot 4 munities (3 in Premium)", "PDF-seizoensrapport (statistieken + detail van de vangsten)", "Foto's in het Logboek — tot 3 per vangst", "Favoriete munities — snelle toegang in de hele app", "150 AI-credits / maand in plaats van 100", "Antwoorden op Claude Opus — diepgaandere analyses", "Cloudsynchronisatie tussen je toestellen (binnenkort beschikbaar)"],
  ...
  en: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Everything included in Premium", "Comparator with up to 4 ammunitions (3 in Premium)", "Season report PDF (statistics + detailed harvest log)", "Photos in the Logbook — up to 3 per entry", "Favorite ammunitions — quick access throughout the app", "150 AI credits / month instead of 100", "Answers on Claude Opus — more in-depth analysis", "Cloud sync across your devices (coming soon)"],
...
export default function ChassIA() {
  ...
  const addCarnetPhoto = (file) => {
    ...
    compressImage(file).then((compressed) => {
      if (compressed) {
        setCarnetDraft(d => ({...d, photos: [...(d.photos||[]), compressed]}));
      } else {
