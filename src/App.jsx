    ...
    <>
      ...
      <style>{`
        @media print {
          ...
          html, body { visibility: hidden; margin: 0; padding: 0; }
          .chassia-print-target {
            visibility: visible;
            position: fixed;
            top: 0; left: 0;
            width: ${printFormat === "A3" ? "297mm" : "210mm"};
            height: ${printFormat === "A3" ? "420mm" : "297mm"};
            background: white;
          ...
          .chassia-print-target svg {
            width: ${printFormat === "A3" ? "240mm" : "170mm"} !important;
            height: ${printFormat === "A3" ? "240mm" : "170mm"} !important;
            display: block !important;
          }
          .chassia-print-header {
            width: ${printFormat === "A3" ? "240mm" : "170mm"};
