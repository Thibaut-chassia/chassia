  ...
  return (
    <>
      ...
      <style>{`
        @media print {
          @page {
            size: ${printFormat === "A3" ? "A3" : "A4"} portrait;
            margin: 8mm;
          }
          ...
          .chassia-print-target svg {
            width: ${printFormat === "A3" ? "260mm" : "180mm"} !important;
            height: ${printFormat === "A3" ? "260mm" : "180mm"} !important;
          }
          .chassia-print-header { width: 100%; font-size: 10pt !important; }
          .chassia-print-specs { width: 100%; font-size: 9pt !important; }
        }
      `}</style>
    </>
  );
