                  ...
                  return (
                    <div key={doc.id} style={{ ...card, padding:"14px 16px", display:"flex", alignItems:"center", gap:14 }}>
                      ...
                      <div style={{ display:"flex", gap:6, flexShrink:0 }}>
                        {stored ? (
                          <>
                            <button onClick={() => { const w = window.open(); w.document.write(`<html><body style="margin:0;background:#000"><img src="${stored.data}" style="width:100%;height:auto;display:block"/></body></html>`); w.document.close(); }}
                              style={{ background:COLORS.accentGlow, color:COLORS.accent, border:`1px solid ${COLORS.accent}`, borderRadius:5, padding:"5px 10px", fontFamily:"'IBM Plex Mono',monospace", fontSize:10, fontWeight:700, cursor:"pointer", display: stored.type === "application/pdf" ? "none" : "block" }}>
                              👁 Voir
                            </button>
                            <a href={stored.data} target="_blank" rel="noopener noreferrer"
                              style={{ background:COLORS.accentGlow, color:COLORS.accent, border:`1px solid ${COLORS.accent}`, borderRadius:5, padding:"5px 10px", fontFamily:"'IBM Plex Mono',monospace", fontSize:10, fontWeight:700, cursor:"pointer", textDecoration:"none", display: stored.type === "application/pdf" ? "block" : "none" }}>
                              👁 Voir
                            </a>
