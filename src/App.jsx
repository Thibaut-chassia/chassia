...
const CARNET_I18N = {
  fr: {
    ...
    backupWarn:"Vos données sont sauvegardées sur cet appareil uniquement. Si vous changez d'appareil ou videz votre navigateur, elles seront perdues. Synchronisation cloud bientôt disponible.",
    viewList:"📋 Liste", viewStats:"📊 Stats",
    formNew:"➕ Nouvelle prise", formEdit:"✏️ Modifier la prise",
    fields:{ date:"Date", espece:"Espèce *", sexe:"Sexe", calibre:"Calibre", munition:"Munition", distance:"Distance de tir (m)", distanceFuite:"Distance de fuite (m)", poids:"Poids animal (kg)", tir:"Type de tir", meteo:"Météo", lieu:"Lieu / Territoire", nbTirs:"Nombre de tirs", emotion:"Émotion ressentie", difficulte:"Difficulté du tir", notes:"Notes" },
    emotionLow:"Sang-froid", emotionHigh:"Adrénaline", diffLow:"Très facile", diffHigh:"Quel tir !",
    notesPlaceholder:"Observations, détails du tir...", save:"💾 Enregistrer", cancel:"Annuler",
    ...
    optTir:{ "Affût":"Affût", "Battue":"Battue", "Approche":"Approche", "Poste fixe":"Poste fixe", "Autre":"Autre" },
    optMeteo:{ "Ensoleillé":"Ensoleillé", "Nuageux":"Nuageux", "Brouillard":"Brouillard", "Pluie légère":"Pluie légère", "Vent fort":"Vent fort", "Neige":"Neige", "Autre":"Autre" },
  },
  nl: {
    gateTitle:"Digitaal jachtlogboek",
    gateDesc:"Noteer elk stuk, volg je statistieken seizoen per seizoen. Premium-functie.",
    activate:"★ Premium activeren",
    title:"📖 Jachtlogboek", season:"Seizoen", take:"stuk", takes:"stukken", newTake:"+ Nieuw stuk",
    backupWarn:"Je gegevens worden enkel op dit toestel opgeslagen. Als je van toestel verandert of je browser wist, gaan ze verloren. Cloudsynchronisatie binnenkort beschikbaar.",
    viewList:"📋 Lijst", viewStats:"📊 Stats",
    ...
    emotionLow:"Koelbloedig", emotionHigh:"Adrenaline", diffLow:"Heel makkelijk", diffHigh:"Wat een schot!",
    notesPlaceholder:"Observaties, details van het schot...", save:"💾 Opslaan", cancel:"Annuleren",
    ...
    optTir:{ "Affût":"Aanzit", "Battue":"Drijfjacht", "Approche":"Bersjacht", "Poste fixe":"Vaste post", "Autre":"Andere" },
    optMeteo:{ "Ensoleillé":"Zonnig", "Nuageux":"Bewolkt", "Brouillard":"Mist", "Pluie légère":"Lichte regen", "Vent fort":"Harde wind", "Neige":"Sneeuw", "Autre":"Andere" },
  },
  de: {
    ...
    backupWarn:"Ihre Daten werden nur auf diesem Gerät gespeichert. Wenn Sie das Gerät wechseln oder den Browser leeren, gehen sie verloren. Cloud-Synchronisierung bald verfügbar.",
    viewList:"📋 Liste", viewStats:"📊 Statistik",
    ...
    emotionLow:"Kaltblütig", emotionHigh:"Adrenalin", diffLow:"Sehr leicht", diffHigh:"Was für ein Schuss!",
    notesPlaceholder:"Beobachtungen, Details zum Schuss...", save:"💾 Speichern", cancel:"Abbrechen",
    ...
    optTir:{ "Affût":"Ansitz", "Battue":"Drückjagd", "Approche":"Pirsch", "Poste fixe":"Fester Stand", "Autre":"Andere" },
    optMeteo:{ "Ensoleillé":"Sonnig", "Nuageux":"Bewölkt", "Brouillard":"Nebel", "Pluie légère":"Leichter Regen", "Vent fort":"Starker Wind", "Neige":"Schnee", "Autre":"Andere" },
  },
  en: {
    ...
    backupWarn:"Your data is saved on this device only. If you change device or clear your browser, it will be lost. Cloud sync coming soon.",
    viewList:"📋 List", viewStats:"📊 Stats",
    ...
    emotionLow:"Cool-headed", emotionHigh:"Adrenaline", diffLow:"Very easy", diffHigh:"What a shot!",
    notesPlaceholder:"Observations, shot details...", save:"💾 Save", cancel:"Cancel",
    ...
    optTir:{ "Affût":"Stand", "Battue":"Driven hunt", "Approche":"Stalking", "Poste fixe":"Fixed post", "Autre":"Other" },
    optMeteo:{ "Ensoleillé":"Sunny", "Nuageux":"Cloudy", "Brouillard":"Fog", "Pluie légère":"Light rain", "Vent fort":"Strong wind", "Neige":"Snow", "Autre":"Other" },
  },
};

const OPT_LABELS = (() => {
  const m = {};
  ["optSexe","optTir","optMeteo"].forEach(set => Object.keys(CARNET_I18N.fr[set]).forEach(fr => {
...
const COFFRE_I18N = {
  fr: {
    ...
    banner:"Vos documents sont sauvegardés sur cet appareil uniquement. Si vous changez d'appareil ou videz votre navigateur, ils seront perdus. Synchronisation cloud bientôt disponible.",
    view:"👁 Voir", replace:"Remplacer", confirm:"Confirmer", add:"+ Ajouter", close:"✕ Fermer", gateTitle:"Coffre-fort numérique", gateDesc:"Stockez vos documents de chasse en lieu sûr : permis, assurance, certificats. Fonctionnalité Premium.", activate:"★ Activer Premium",
    docs:{
      ...
      modele9_1:{ label:"Modèle 9 — Arme 1", desc:"Document d'enregistrement arme 1" },
      modele9_2:{ label:"Modèle 9 — Arme 2", desc:"Document d'enregistrement arme 2" },
      modele9_3:{ label:"Modèle 9 — Arme 3", desc:"Document d'enregistrement arme 3" },
      modele9_4:{ label:"Modèle 9 — Arme 4", desc:"Document d'enregistrement arme 4" },
      modele9_5:{ label:"Modèle 9 — Arme 5", desc:"Document d'enregistrement arme 5" },
      permis_cond:{ label:"Permis de conduire", desc:"Recto / Verso" },
    },
  },
  nl: {
    intro:"Bewaar hier de foto's of PDF's van je belangrijke documenten. Offline beschikbaar, enkel op je toestel opgeslagen.",
    banner:"Je documenten worden enkel op dit toestel opgeslagen. Als je van toestel verandert of je browser wist, gaan ze verloren. Cloudsynchronisatie binnenkort beschikbaar.",
    view:"👁 Bekijken", replace:"Vervangen", confirm:"Bevestigen", add:"+ Toevoegen", close:"✕ Sluiten", gateTitle:"Digitale kluis", gateDesc:"Bewaar je jachtdocumenten veilig: jachtverlof, verzekering, certificaten. Premium-functie.", activate:"★ Premium activeren",
    docs:{
      ...
      modele9_1:{ label:"Model 9 — Wapen 1", desc:"Registratiedocument wapen 1" },
      modele9_2:{ label:"Model 9 — Wapen 2", desc:"Registratiedocument wapen 2" },
      modele9_3:{ label:"Model 9 — Wapen 3", desc:"Registratiedocument wapen 3" },
      modele9_4:{ label:"Model 9 — Wapen 4", desc:"Registratiedocument wapen 4" },
      modele9_5:{ label:"Model 9 — Wapen 5", desc:"Registratiedocument wapen 5" },
      permis_cond:{ label:"Rijbewijs", desc:"Voorzijde / Achterzijde" },
    },
  },
  de: {
    intro:"Speichern Sie hier Fotos oder PDFs Ihrer wichtigen Dokumente. Offline verfügbar, nur auf Ihrem Gerät gespeichert.",
    banner:"Ihre Dokumente werden nur auf diesem Gerät gespeichert. Wenn Sie das Gerät wechseln oder den Browser leeren, gehen sie verloren. Cloud-Synchronisierung bald verfügbar.",
    view:"👁 Ansehen", replace:"Ersetzen", confirm:"Bestätigen", add:"+ Hinzufügen", close:"✕ Schließen", gateTitle:"Digitaler Tresor", gateDesc:"Bewahren Sie Ihre Jagddokumente sicher auf: Jagdschein, Versicherung, Bescheinigungen. Premium-Funktion.", activate:"★ Premium aktivieren",
    docs:{
      ...
      modele9_1:{ label:"Modell 9 — Waffe 1", desc:"Registrierungsdokument Waffe 1" },
      modele9_2:{ label:"Modell 9 — Waffe 2", desc:"Registrierungsdokument Waffe 2" },
      modele9_3:{ label:"Modell 9 — Waffe 3", desc:"Registrierungsdokument Waffe 3" },
      modele9_4:{ label:"Modell 9 — Waffe 4", desc:"Registrierungsdokument Waffe 4" },
      modele9_5:{ label:"Modell 9 — Waffe 5", desc:"Registrierungsdokument Waffe 5" },
      permis_cond:{ label:"Führerschein", desc:"Vorderseite / Rückseite" },
    },
  },
  en: {
    intro:"Store photos or PDFs of your important documents here. Available offline, stored only on your device.",
    banner:"Your documents are saved on this device only. If you change device or clear your browser, they will be lost. Cloud sync coming soon.",
    view:"👁 View", replace:"Replace", confirm:"Confirm", add:"+ Add", close:"✕ Close", gateTitle:"Digital safe", gateDesc:"Store your hunting documents securely: licence, insurance, certificates. Premium feature.", activate:"★ Activate Premium",
    docs:{
      ...
      modele9_1:{ label:"Model 9 — Weapon 1", desc:"Weapon 1 registration document" },
      modele9_2:{ label:"Model 9 — Weapon 2", desc:"Weapon 2 registration document" },
      modele9_3:{ label:"Model 9 — Weapon 3", desc:"Weapon 3 registration document" },
      modele9_4:{ label:"Model 9 — Weapon 4", desc:"Weapon 4 registration document" },
      modele9_5:{ label:"Model 9 — Weapon 5", desc:"Weapon 5 registration document" },
      permis_cond:{ label:"Driver's license", desc:"Front / Back" },
    },
  },
};
...
const UIX_I18N = {
  fr: {
    ...
    leadFreeToggle:"🌿 Sans plomb 🌿", compare3Upsell:"Passe Premium pour comparer une 3ᵉ munition",
    premiumDist:"★ Premium : Distance libre 10–300m", premiumDRO:"★ Premium : DRO libre 10–300m",
    addGame:"— Ajouter un gibier (jusqu'à 5) —", clearAll:"Effacer tout", munOptional:"Munition (optionnel)", upTo5:"jusqu'à 5", munition:"Munition", calRec:"Calibres recommandés", calibreStar:"Calibre *", calibreLabel:"Calibre", distanceM:"Distance (m)", wetlandMandatory:"Obligatoire zones humides", atDist:"à", modeDescBattue:"Ogives à expansion rapide — choc et arrêt immédiats pour la battue", modeDescAffut:"Ogives longue portée — expansion progressive et haute rétention de masse", modeDescPoly:"Ogives polyvalentes — efficaces sur toutes distances", moreChoicesBtn:"🤖 Choix supplémentaires & conseil IA approfondi", deepAdviceBtn:"🤖 Conseil IA approfondi", federal:"Fédéral", notApplicable:"— Non applicable —", modeCarabine:"🔫 Carabine", modeFusil:"🦆 Fusil", modeComparer:"📊 Comparer", premiumUnlimited:"🌿 PREMIUM — Questions illimitées", memoryActive:"Mémoire active — l'IA se souvient de tout l'échange", opusAnalysis:"Assistant IA sur Claude Opus — analyse approfondie", examplesTitle:"Quelques exemples de questions :", suggestion:"Suggestion", coffreErrFormat:"Format non supporté — utilisez une photo (JPG, PNG) ou un PDF.", coffreErrSize:"Fichier trop volumineux — maximum 5 MB.", leadFreeShort:"🌿 Sans plomb", leadShort:"Plomb", compareIntro:"Compare la trajectoire de plusieurs munitions du même calibre.", compareMax3:"Jusqu'à 3 munitions.", compareFree:"Version gratuite : 2 munitions (3 en Premium).", chartLegend:"Valeurs en cm vs ligne de visée", chartDelta:" · Δ = écart entre les deux", fusilRec:"🔫 Fusils recommandés", aiDeepBtn:"🤖 Analyse IA approfondie — conseil personnalisé", aiLoading:"⏳ Analyse en cours...", premiumAi:"Passer Premium — Analyse IA approfondie", clearConv:"✕ Effacer la conversation",
  ...
  nl: {
    ...
    leadFreeToggle:"🌿 Loodvrij 🌿", compare3Upsell:"Word Premium om een 3ᵉ munitie te vergelijken",
    premiumDist:"★ Premium: vrije afstand 10–300m", premiumDRO:"★ Premium: vrije DRO 10–300m",
    addGame:"— Wild toevoegen (tot 5) —", clearAll:"Alles wissen", munOptional:"Munitie (optioneel)", upTo5:"tot 5", munition:"Munitie", calRec:"Aanbevolen kalibers", calibreStar:"Kaliber *", calibreLabel:"Kaliber", distanceM:"Afstand (m)", wetlandMandatory:"Verplicht in waterrijk gebied", atDist:"op", modeDescBattue:"Kogels met snelle expansie — onmiddellijke schok en stop voor de drijfjacht", modeDescAffut:"Kogels voor lange afstand — geleidelijke expansie en hoog massabehoud", modeDescPoly:"Veelzijdige kogels — doeltreffend op alle afstanden", moreChoicesBtn:"🤖 Extra keuzes & uitgebreid AI-advies", deepAdviceBtn:"🤖 Uitgebreid AI-advies", federal:"Federaal", notApplicable:"— Niet van toepassing —", modeCarabine:"🔫 Geweer", modeFusil:"🦆 Hagelgeweer", modeComparer:"📊 Vergelijken", premiumUnlimited:"🌿 PREMIUM — Onbeperkte vragen", memoryActive:"Actief geheugen — de AI onthoudt het volledige gesprek", opusAnalysis:"AI-assistent op Claude Opus — uitgebreide analyse", examplesTitle:"Enkele voorbeeldvragen:", suggestion:"Suggestie", coffreErrFormat:"Niet-ondersteund formaat — gebruik een foto (JPG, PNG) of een PDF.", coffreErrSize:"Bestand te groot — maximaal 5 MB.", leadFreeShort:"🌿 Loodvrij", leadShort:"Lood", compareIntro:"Vergelijk de kogelbaan van meerdere munities van hetzelfde kaliber.", compareMax3:"Tot 3 munities.", compareFree:"Gratis versie: 2 munities (3 in Premium).", chartLegend:"Waarden in cm t.o.v. vizierlijn", chartDelta:" · Δ = verschil tussen beide", fusilRec:"🔫 Aanbevolen geweren", aiDeepBtn:"🤖 Uitgebreide AI-analyse — persoonlijk advies", aiLoading:"⏳ Analyse loopt...", premiumAi:"Word Premium — Uitgebreide AI-analyse", clearConv:"✕ Gesprek wissen",
  ...
  de: {
    ...
    leadFreeToggle:"🌿 Bleifrei 🌿", compare3Upsell:"Premium für den Vergleich einer 3. Munition",
    premiumDist:"★ Premium: freie Distanz 10–300m", premiumDRO:"★ Premium: freie DRO 10–300m",
    addGame:"— Wild hinzufügen (bis zu 5) —", clearAll:"Alles löschen", munOptional:"Munition (optional)", upTo5:"bis zu 5", munition:"Munition", calRec:"Empfohlene Kaliber", calibreStar:"Kaliber *", calibreLabel:"Kaliber", distanceM:"Entfernung (m)", wetlandMandatory:"In Feuchtgebieten vorgeschrieben", atDist:"auf", modeDescBattue:"Geschosse mit schneller Expansion — sofortiger Schock und Stopp für die Drückjagd", modeDescAffut:"Geschosse für lange Distanz — progressive Expansion und hohe Masseerhaltung", modeDescPoly:"Vielseitige Geschosse — wirksam auf allen Distanzen", moreChoicesBtn:"🤖 Zusätzliche Optionen & vertiefte KI-Beratung", deepAdviceBtn:"🤖 Vertiefte KI-Beratung", federal:"Föderal", notApplicable:"— Nicht zutreffend —", modeCarabine:"🔫 Büchse", modeFusil:"🦆 Flinte", modeComparer:"📊 Vergleichen", premiumUnlimited:"🌿 PREMIUM — Unbegrenzte Fragen", memoryActive:"Aktives Gedächtnis — die KI erinnert sich an das gesamte Gespräch", opusAnalysis:"KI-Assistent auf Claude Opus — vertiefte Analyse", examplesTitle:"Einige Beispielfragen:", suggestion:"Vorschlag", coffreErrFormat:"Nicht unterstütztes Format — verwenden Sie ein Foto (JPG, PNG) oder ein PDF.", coffreErrSize:"Datei zu groß — maximal 5 MB.", leadFreeShort:"🌿 Bleifrei", leadShort:"Blei", compareIntro:"Vergleicht die Flugbahn mehrerer Munitionen desselben Kalibers.", compareMax3:"Bis zu 3 Munitionen.", compareFree:"Kostenlose Version: 2 Munitionen (3 in Premium).", chartLegend:"Werte in cm zur Visierlinie", chartDelta:" · Δ = Differenz zwischen beiden", fusilRec:"🔫 Empfohlene Flinten", aiDeepBtn:"🤖 Vertiefte KI-Analyse — persönliche Beratung", aiLoading:"⏳ Analyse läuft...", premiumAi:"Premium werden — Vertiefte KI-Analyse", clearConv:"✕ Unterhaltung löschen",
  ...
  en: {
    ...
    leadFreeToggle:"🌿 Lead-free 🌿", compare3Upsell:"Go Premium to compare a 3rd ammunition",
    premiumDist:"★ Premium: free distance 10–300m", premiumDRO:"★ Premium: free DRO 10–300m",
    addGame:"— Add game (up to 5) —", clearAll:"Clear all", munOptional:"Ammunition (optional)", upTo5:"up to 5", munition:"Ammunition", calRec:"Recommended calibers", calibreStar:"Caliber *", calibreLabel:"Caliber", distanceM:"Distance (m)", wetlandMandatory:"Mandatory in wetlands", atDist:"at", modeDescBattue:"Rapid-expansion bullets — immediate shock and stop for driven hunts", modeDescAffut:"Long-range bullets — progressive expansion and high weight retention", modeDescPoly:"Versatile bullets — effective at all ranges", moreChoicesBtn:"🤖 Additional choices & in-depth AI advice", deepAdviceBtn:"🤖 In-depth AI advice", federal:"Federal", notApplicable:"— Not applicable —", modeCarabine:"🔫 Rifle", modeFusil:"🦆 Shotgun", modeComparer:"📊 Compare", premiumUnlimited:"🌿 PREMIUM — Unlimited questions", memoryActive:"Active memory — the AI remembers the whole conversation", opusAnalysis:"AI Assistant on Claude Opus — in-depth analysis", examplesTitle:"Some example questions:", suggestion:"Suggestion", coffreErrFormat:"Unsupported format — use a photo (JPG, PNG) or a PDF.", coffreErrSize:"File too large — maximum 5 MB.", leadFreeShort:"🌿 Lead-free", leadShort:"Lead", compareIntro:"Compare the trajectory of several ammunitions of the same caliber.", compareMax3:"Up to 3 ammunitions.", compareFree:"Free version: 2 ammunitions (3 in Premium).", chartLegend:"Values in cm vs line of sight", chartDelta:" · Δ = difference between the two", fusilRec:"🔫 Recommended shotguns", aiDeepBtn:"🤖 In-depth AI analysis — personalized advice", aiLoading:"⏳ Analyzing...", premiumAi:"Go Premium — In-depth AI analysis", clearConv:"✕ Clear conversation",
...
// ─── TRADUCTIONS DES NOTES DE RECOMMANDATION CALIBRE/MUNITION (79 entrées) ──
const NOTE_I18N = {
  fr: [
...
export default function ChassIA() {
  ...
  const saveCoffre = (data) => { try { localStorage.setItem(COFFRE_KEY, JSON.stringify(data)); } catch {} };
  ...
  const uploadDoc = (id, file) => {
    ...
    if (file.size > 5 * 1024 * 1024) { setCoffreError(UIX.coffreErrSize); return; }
    setCoffreError("");
    const reader = new FileReader();
    reader.onload = (e) => {
      const updated = { ...coffreData, [id]: { name: file.name, type: file.type, data: e.target.result } };
      setCoffreData(updated); saveCoffre(updated);
    };
  ...
  const BACKUP_DATE_KEY = "chassia_last_backup";
  const getLastBackup = () => { try { return localStorage.getItem(BACKUP_DATE_KEY) || null; } catch { return null; } };
  const setLastBackup = () => { try { localStorage.setItem(BACKUP_DATE_KEY, new Date().toISOString()); } catch {} };
  const [lastBackupDate, setLastBackupDate] = useState(getLastBackup);

  // Sauvegarde silencieuse localStorage à chaque modif carnet
  const saveCarnetWithBackup = (entries) => {
    saveCarnet(entries);
    setLastBackup();
...
Réponds avec des ### titres, sois très précis sur les valeurs numériques.`;
    try {
      ...
      setCustomResult(resp);
    } catch(e) {
      setCustomResult(UIX.errorPrefix + (e?.message || String(e)));
    } finally {
                    ...
                    {isPremium ? (
                      <div>
                        <button onClick={calculerCibleCustom} disabled={loadingCustom}
                          ...
                          {loadingCustom ? UIX.aiLoading : UIX.aiDeepBtn}
                        </button>
                        {loadingCustom && <Loader lang={lang} />}
                      ...
                      <button onClick={() => setIsPremium(true)}
                        ...
                        <div style={{textAlign:"left"}}>
                          <div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:10,fontWeight:700,color:COLORS.accent}}>{UIX.premiumAi}</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                  <div>
                    <label style={fieldLabel}>
                      {T.gibierLabel}
                      <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color: COLORS.accent, marginLeft:8 }}>{UIX.upTo5}</span>
                    </label>
                    <div>
                        <select onChange={e => {
                    ...
                    {isPremium && (
                      <button style={{ ...btnPrimary, opacity: (!gibierM || !calibreFusil) ? 0.5 : 1 }}
                        onClick={() => {
                          ...
                          askClaude(prompt, T.system).then(r => { setConseilMun(r); }).catch((err) => { setConseilMun(UIX.errorPrefix + (err?.message || String(err))); }).finally(() => { setLoadingM(false); });
                        }}
                ...
                return (
                  <div className="fade-in">
                    <p style={{ color: COLORS.textDim, fontSize:"0.95rem", marginBottom:16, fontStyle:"italic" }}>
                      {UIX.compareIntro} {isPremium ? UIX.compareMax3 : UIX.compareFree}
                    </p>
                      ...
                      {isPremium ? (
                        ...
                        <div style={{ gridColumn:"1 / -1" }}>
                          <div onClick={() => setIsPremium(true)} style={{ cursor:"pointer", border:`1px dashed ${COLORS.accent}`, borderRadius:6, padding:"8px 12px", display:"flex", alignItems:"center", justifyContent:"center", gap:6, background:COLORS.accentGlow }}>
                            ...
                            <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:10, color:COLORS.accent }}>{UIX.compare3Upsell}</span>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    {(f1 && f2) && (
                      <div style={{ ...card, padding:0, overflow:"hidden" }}>
                        ...
                        <div style={{ padding:"6px 8px", fontFamily:"monospace", fontSize:"0.6rem", color:COLORS.textDim, textAlign:"center" }}>
                          {UIX.chartLegend}{!f3 ? UIX.chartDelta : ""}
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {isPremium && (
                    <div style={{ display:"flex", flexDirection:"column", gap:4 }}>
                      <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize: 11, color: COLORS.accent }}>
                        {UIX.premiumUnlimited}
                      </div>
                      <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize: 10, color: COLORS.textDim, display:"flex", alignItems:"center", gap:5 }}>
                        <span style={{ color: COLORS.accent }}>◈</span> {UIX.memoryActive}
                      </div>
                      <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize: 10, color: COLORS.textDim, display:"flex", alignItems:"center", gap:5 }}>
                        <span style={{ color: COLORS.accent }}>⚡</span> {UIX.opusAnalysis}
                      </div>
                    </div>
                  )}
                </div>
              ...
              {!isPremium ? (
                <div style={card}>
                  <div style={{ textAlign:"center", padding:"20px 0" }}>
                    ...
                    <button onClick={() => setIsPremium(true)} style={{ background: COLORS.accent, color:COLORS.onAccent, border:"none", borderRadius:8, padding:"12px 28px", fontFamily:"'IBM Plex Mono',monospace", fontSize:13, fontWeight:700, cursor:"pointer" }}>{CN.activate}</button>
                  </div>
                </div>
              ) : (() => {
                // Filtrer par saison
                      ...
                      <div style={card}>
                        ...
                        <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                          {[
                            ...
                            <div key={key}>
                              <label style={lblStyle}>{CN.fields[key] || label}</label>
                              {type === "select" ? (
                          ...
                          {/* Slider Émotion */}
                          <div>
                            <label style={lblStyle}>{CN.fields.emotion}</label>
                          ...
                          {/* Slider Difficulté */}
                          <div>
                            <label style={lblStyle}>{CN.fields.difficulte}</label>
                          ...
                          <div>
                            <label style={lblStyle}>{CN.fields.notes}</label>
                            <textarea value={carnetDraft.notes||""} onChange={e => setCarnetDraft(d=>({...d,notes:e.target.value}))} rows={3} style={{...fieldStyle, resize:"vertical"}} placeholder={CN.notesPlaceholder}/>
                          </div>
                        </div>
                        <div style={{ display:"flex", gap:10, marginTop:16 }}>
                          <button onClick={() => {
                            ...
                            const updated = carnetDraft.id
                              ...
                              : [entry, ...carnetEntries];
                            setCarnetEntries(updated); saveCarnetWithBackup(updated);
                          ...
                          {[...filtered].sort((a,b)=>b.date.localeCompare(a.date)).map(entry => (
                            <div key={entry.id} style={{ ...card, padding:"12px 14px" }}>
                              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                                <div>
                                  <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:13, color:COLORS.white, fontWeight:700 }}>{entry.espece ? spLabel(entry.espece, lang) : "—"}{entry.sexe ? ` · ${entry.sexe}` : ""}</div>
                                ...
                                {confirmDelete === entry.id ? (
                                  ...
                                  <div style={{ display:"flex", gap:6 }}>
                                    ...
                                    <button onClick={() => setConfirmDelete(entry.id)} style={{ background:"transparent", border:`1px solid ${COLORS.danger}`, borderRadius:5, padding:"4px 8px", color:COLORS.danger, fontSize:10, cursor:"pointer" }}>🗑</button>
                                  </div>
                                )}
                              </div>
            ...
            <div className="fade-in">
              {!isPremium ? (
                <div style={card}>
                  <div style={{ textAlign:"center", padding:"20px 0" }}>
                    ...
                    <button onClick={() => setIsPremium(true)} style={{ background: COLORS.accent, color:COLORS.onAccent, border:"none", borderRadius:8, padding:"12px 28px", fontFamily:"'IBM Plex Mono',monospace", fontSize:13, fontWeight:700, cursor:"pointer" }}>{CF.activate}</button>
                  </div>
                </div>
              ) : (
              <>
              ...
              {coffreError && (
                <div style={{ background:COLORS.accentGlow, border:`1px solid ${COLORS.danger}`, borderRadius:8, padding:"10px 14px", marginBottom:16, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10 }}>
                  ...
                  <button onClick={() => setCoffreError("")} style={{ background:"transparent", border:"none", color:COLORS.danger, fontSize:14, cursor:"pointer", padding:0, lineHeight:1 }}>✕</button>
                </div>
              )}
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                {[
                  ...
                  { id:"modele9_1",     emoji:"📋", label:"Modèle 9 — Arme 1",               desc:"Document d'enregistrement arme 1" },
                  { id:"modele9_2",     emoji:"📋", label:"Modèle 9 — Arme 2",               desc:"Document d'enregistrement arme 2" },
                  { id:"modele9_3",     emoji:"📋", label:"Modèle 9 — Arme 3",               desc:"Document d'enregistrement arme 3" },
                  { id:"modele9_4",     emoji:"📋", label:"Modèle 9 — Arme 4",               desc:"Document d'enregistrement arme 4" },
                  { id:"modele9_5",     emoji:"📋", label:"Modèle 9 — Arme 5",               desc:"Document d'enregistrement arme 5" },
                          ...
                          <>
                            <button onClick={() => {
                              if (stored.type === "application/pdf") {
                                ...
                                const w = window.open();
                                w.document.write(`<html><head><title>${stored.name}</title><style>body{margin:0;background:#000;display:flex;flex-direction:column;align-items:center}button{position:fixed;top:12px;right:12px;background:#c8f135;color:#000;border:none;border-radius:8px;padding:8px 16px;font-size:14px;font-weight:700;cursor:pointer;z-index:9999}img{width:100%;height:auto;display:block;margin-top:0}</style></head><body><button onclick="window.close()">${CF.close}</button><img src="${stored.data}"/></body></html>`);
                                w.document.close();
                              }
                            }}
