...
const UIX_I18N = {
  fr: {
    syncSignIn:"Se connecter avec Google", syncSignOut:"Se déconnecter", syncExplain:"Connecte-toi pour synchroniser tes données entre appareils.", syncConnectedPrefix:"Connecté :",
  ...
  nl: {
    syncSignIn:"Inloggen met Google", syncSignOut:"Afmelden", syncExplain:"Log in om je gegevens tussen toestellen te synchroniseren.", syncConnectedPrefix:"Verbonden:",
  ...
  de: {
    syncSignIn:"Mit Google anmelden", syncSignOut:"Abmelden", syncExplain:"Melde dich an, um deine Daten zwischen Geräten zu synchronisieren.", syncConnectedPrefix:"Verbunden:",
  ...
  en: {
    syncSignIn:"Sign in with Google", syncSignOut:"Sign out", syncExplain:"Sign in to sync your data across devices.", syncConnectedPrefix:"Connected:",
