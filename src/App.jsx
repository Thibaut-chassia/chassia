              ...
              {!isPremium ? (
                ...
                return (
                  <div>
                    ...
                    {carnetView === "stats" && (
                      isPremiumPlus ? (
                        <button onClick={() => { setPrintFormat("A4"); setTimeout(() => window.print(), 150); }} style={{ ...btnPrimary, width:"100%", marginBottom:16, background:"transparent", border:`1px solid ${COLORS.accent}`, color:COLORS.accent, fontSize:12, display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
