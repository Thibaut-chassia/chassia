...
const COFFRE_I18N = {
  fr: {
    ...
    view:"👁 Voir", replace:"Remplacer", confirm:"Confirmer", add:"+ Ajouter", close:"✕ Fermer",
    docs:{
  ...
  nl: {
    ...
    view:"👁 Bekijken", replace:"Vervangen", confirm:"Bevestigen", add:"+ Toevoegen", close:"✕ Sluiten",
    docs:{
  ...
  de: {
    ...
    view:"👁 Ansehen", replace:"Ersetzen", confirm:"Bestätigen", add:"+ Hinzufügen", close:"✕ Schließen",
    docs:{
  ...
  en: {
    ...
    view:"👁 View", replace:"Replace", confirm:"Confirm", add:"+ Add", close:"✕ Close",
    docs:{
...
const UIX_I18N = {
  fr: {
    ...
    addGame:"— Ajouter un gibier (jusqu'à 5) —", clearAll:"Effacer tout", munOptional:"Munition (optionnel)", upTo5:"jusqu'à 5", munition:"Munition", calRec:"Calibres recommandés", fusilRec:"🔫 Fusils recommandés", aiDeepBtn:"🤖 Analyse IA approfondie — conseil personnalisé", aiLoading:"⏳ Analyse en cours...", premiumAi:"Passer Premium — Analyse IA approfondie", clearConv:"✕ Effacer la conversation",
  ...
  nl: {
    ...
    addGame:"— Wild toevoegen (tot 5) —", clearAll:"Alles wissen", munOptional:"Munitie (optioneel)", upTo5:"tot 5", munition:"Munitie", calRec:"Aanbevolen kalibers", fusilRec:"🔫 Aanbevolen geweren", aiDeepBtn:"🤖 Uitgebreide AI-analyse — persoonlijk advies", aiLoading:"⏳ Analyse loopt...", premiumAi:"Word Premium — Uitgebreide AI-analyse", clearConv:"✕ Gesprek wissen",
  ...
  en: {
    ...
    addGame:"— Add game (up to 5) —", clearAll:"Clear all", munOptional:"Ammunition (optional)", upTo5:"up to 5", munition:"Ammunition", calRec:"Recommended calibers", fusilRec:"🔫 Recommended shotguns", aiDeepBtn:"🤖 In-depth AI analysis — personalized advice", aiLoading:"⏳ Analyzing...", premiumAi:"Go Premium — In-depth AI analysis", clearConv:"✕ Clear conversation",
...
const FUSIL_PLOMBS = {
  "Bécasse des bois":   { plombs:"n°7–8",              charge:"28–32g", note:noteAt(0, lang) },
  "Faisan de chasse":   { plombs:"n°5–6",              charge:"32–36g", note:noteAt(1, lang) },
  "Perdrix grise":      { plombs:"n°6–7",              charge:"28–32g", note:noteAt(2, lang) },
  "Lièvre brun":        { plombs:"n°4–5",              charge:"32–36g", note:noteAt(3, lang) },
  "Lapin de garenne":   { plombs:"n°5–6",              charge:"28–32g", note:noteAt(4, lang) },
  "Pigeon ramier":      { plombs:"n°5–6",              charge:"30–34g", note:noteAt(5, lang) },
  "Canard colvert":     { plombs:"acier n°3–4",        charge:"32–36g", note:noteAt(6, lang) },
  "Bernache du Canada": { plombs:"acier n°1–2",        charge:"36–42g", note:noteAt(7, lang) },
  "Foulque macroule":   { plombs:"acier n°4–5",        charge:"30–34g", note:noteAt(8, lang) },
  "Renard roux":        { plombs:"n°2–3", charge:"34–38g", note:noteAt(9, lang) },
  "Sanglier":           { plombs:"Balle fusil uniquement", charge:"Balle fusil", note:noteAt(10, lang) },
};
...
export default function ChassIA() {
  ...
  const uploadDoc = (id, file) => {
    ...
    if (!["image/jpeg","image/png","image/webp","application/pdf"].includes(file.type)) {
      setCoffreError("Format non supporté — utilisez une photo (JPG, PNG) ou un PDF."); return;
    }
    if (file.size > 5 * 1024 * 1024) { setCoffreError("Fichier trop volumineux — maximum 5 MB."); return; }
    setCoffreError("");
                          ...
                          {recSP && (
                            <div style={{ background: COLORS.bgInput, border:`1px solid ${COLORS.leadFree}40`, borderLeft:`3px solid ${COLORS.leadFree}`, borderRadius:7, padding:"12px 14px" }}>
                              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:4 }}>
                                ...
                                <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color:COLORS.leadFree }}>Obligatoire zones humides</span>
                              </div>
