...
const LANGS = {
  fr: {
    ...
    limitText:"Tu as utilisé tes 3 questions gratuites du jour. Passe en Premium pour plus de questions IA.",
    ...
    freeNote:"Version gratuite : 3 questions / jour · Plus de questions avec Premium",
  ...
  nl: {
    ...
    limitText:"Je hebt je 3 gratis vragen van vandaag gebruikt. Ga naar Premium voor meer AI-vragen.",
    assistPH:"Stel je vraag over de jacht in België… (Enter om te verzenden)",
    assistLimitPH:"Daglimiet bereikt — upgrade naar Premium",
    freeNote:"Gratis versie: 3 vragen/dag · Meer vragen met Premium",
  ...
  de: {
    ...
    limitText:"Sie haben Ihre 3 kostenlosen Fragen für heute verbraucht. Wechseln Sie zu Premium für mehr KI-Fragen.",
    ...
    freeNote:"Kostenlose Version: 3 Fragen/Tag · Mehr Fragen mit Premium",
  ...
  en: {
    ...
    limitText:"You have used your 3 free questions for today. Go Premium for more AI questions.",
    assistPH:"Ask your question about hunting in Belgium… (Enter to send)",
    assistLimitPH:"Daily limit reached — upgrade to Premium",
    freeNote:"Free version: 3 questions/day · More questions with Premium",
...
const UIX_I18N = {
  fr: {
    ...
    addGame:"— Ajouter un gibier (jusqu'à 5) —", clearAll:"Effacer tout", munOptional:"Munition (optionnel)", upTo5:"jusqu'à 5", munition:"Munition", calRec:"Calibres recommandés", calibreStar:"Calibre *", calibreLabel:"Calibre", distanceM:"Distance (m)", wetlandMandatory:"Obligatoire zones humides", atDist:"à", modeDescBattue:"Ogives à expansion rapide — choc et arrêt immédiats pour la battue", modeDescAffut:"Ogives longue portée — expansion progressive et haute rétention de masse", modeDescPoly:"Ogives polyvalentes — efficaces sur toutes distances", moreChoicesBtn:"🤖 Choix supplémentaires & conseil IA approfondi", deepAdviceBtn:"🤖 Conseil IA approfondi", federal:"Fédéral", notApplicable:"— Non applicable —", modeCarabine:"🔫 Carabine", modeFusil:"🦆 Fusil", modeComparer:"📊 Comparer", memoryActive:"Mémoire active — l'IA se souvient de tout l'échange", opusAnalysis:"Assistant IA sur Claude Opus — analyse approfondie", sonnetAnalysis:"Assistant IA sur Claude Sonnet", upgradeNudge:"Envie de réponses plus poussées et de 150 crédits/mois ? Passe à Premium+ →", creditsLabel:"crédits IA / mois (toutes fonctions confondues)", quotaMsgPrefix:"⚠️ Limite mensuelle de ", quotaMsgSuffix:" crédits IA atteinte (toutes fonctions IA confondues : Assistant, Conseil calibre, Conseil munition). Elle se renouvelle automatiquement le 1er du mois.", premiumPlusBtn:"Passer Premium+", examplesTitle:"Quelques exemples de questions :", suggestion:"Suggestion", coffreErrFormat:"Format non supporté — utilisez une photo (JPG, PNG) ou un PDF.", coffreErrSize:"Fichier trop volumineux — maximum 5 MB.", coffreErrStorage:"Espace de stockage plein sur cet appareil. Supprimez un document existant avant d'en ajouter un nouveau.", leadFreeShort:"🌿 Sans plomb", leadShort:"Plomb", compareIntro:"Compare la trajectoire de plusieurs munitions du même calibre.", compareMax3:"Jusqu'à 3 munitions.", compareFree:"Version gratuite : 2 munitions (3 en Premium).", chartLegend:"Valeurs en cm vs ligne de visée", chartDelta:" · Δ = écart entre les deux", fusilRec:"🔫 Fusils recommandés", aiDeepBtn:"🤖 Analyse IA approfondie — conseil personnalisé", clearConv:"✕ Effacer la conversation",
  ...
  de: {
    ...
    addGame:"— Wild hinzufügen (bis zu 5) —", clearAll:"Alles löschen", munOptional:"Munition (optional)", upTo5:"bis zu 5", munition:"Munition", calRec:"Empfohlene Kaliber", calibreStar:"Kaliber *", calibreLabel:"Kaliber", distanceM:"Entfernung (m)", wetlandMandatory:"In Feuchtgebieten vorgeschrieben", atDist:"auf", modeDescBattue:"Geschosse mit schneller Expansion — sofortiger Schock und Stopp für die Drückjagd", modeDescAffut:"Geschosse für lange Distanz — progressive Expansion und hohe Masseerhaltung", modeDescPoly:"Vielseitige Geschosse — wirksam auf allen Distanzen", moreChoicesBtn:"🤖 Zusätzliche Optionen & vertiefte KI-Beratung", deepAdviceBtn:"🤖 Vertiefte KI-Beratung", federal:"Föderal", notApplicable:"— Nicht zutreffend —", modeCarabine:"🔫 Büchse", modeFusil:"🦆 Flinte", modeComparer:"📊 Vergleichen", memoryActive:"Aktives Gedächtnis — die KI erinnert sich an das gesamte Gespräch", opusAnalysis:"KI-Assistent auf Claude Opus — vertiefte Analyse", sonnetAnalysis:"KI-Assistent auf Claude Sonnet", upgradeNudge:"Lust auf tiefgründigere Antworten und 150 Credits/Monat? Wechsle zu Premium+ →", creditsLabel:"KI-Credits / Monat (alle Funktionen zusammen)", quotaMsgPrefix:"⚠️ Monatliches Limit von ", quotaMsgSuffix:" KI-Credits erreicht (alle KI-Funktionen zusammen: Assistent, Kaliberberatung, Munitionsberatung). Wird automatisch am 1. des Monats zurückgesetzt.", premiumPlusBtn:"Zu Premium+ wechseln", examplesTitle:"Einige Beispielfragen:", suggestion:"Vorschlag", coffreErrFormat:"Nicht unterstütztes Format — verwenden Sie ein Foto (JPG, PNG) oder ein PDF.", coffreErrSize:"Datei zu groß — maximal 5 MB.", coffreErrStorage:"Speicherplatz auf diesem Gerät voll. Löschen Sie ein vorhandenes Dokument, bevor Sie ein neues hinzufügen.", leadFreeShort:"🌿 Bleifrei", leadShort:"Blei", compareIntro:"Vergleicht die Flugbahn mehrerer Munitionen desselben Kalibers.", compareMax3:"Bis zu 3 Munitionen.", compareFree:"Kostenlose Version: 2 Munitionen (3 in Premium).", chartLegend:"Werte in cm zur Visierlinie", chartDelta:" · Δ = Differenz zwischen beiden", fusilRec:"🔫 Empfohlene Flinten", aiDeepBtn:"🤖 Vertiefte KI-Analyse — persönliche Beratung", clearConv:"✕ Unterhaltung löschen",
  ...
  en: {
    ...
    addGame:"— Add game (up to 5) —", clearAll:"Clear all", munOptional:"Ammunition (optional)", upTo5:"up to 5", munition:"Ammunition", calRec:"Recommended calibers", calibreStar:"Caliber *", calibreLabel:"Caliber", distanceM:"Distance (m)", wetlandMandatory:"Mandatory in wetlands", atDist:"at", modeDescBattue:"Rapid-expansion bullets — immediate shock and stop for driven hunts", modeDescAffut:"Long-range bullets — progressive expansion and high weight retention", modeDescPoly:"Versatile bullets — effective at all ranges", moreChoicesBtn:"🤖 Additional choices & in-depth AI advice", deepAdviceBtn:"🤖 In-depth AI advice", federal:"Federal", notApplicable:"— Not applicable —", modeCarabine:"🔫 Rifle", modeFusil:"🦆 Shotgun", modeComparer:"📊 Compare", memoryActive:"Active memory — the AI remembers the whole conversation", opusAnalysis:"AI Assistant on Claude Opus — in-depth analysis", sonnetAnalysis:"AI Assistant on Claude Sonnet", upgradeNudge:"Want deeper answers and 150 credits/month? Upgrade to Premium+ →", creditsLabel:"AI credits / month (all features combined)", quotaMsgPrefix:"⚠️ Monthly limit of ", quotaMsgSuffix:" AI credits reached (all AI features combined: Assistant, Caliber advice, Ammunition advice). Automatically renews on the 1st of the month.", premiumPlusBtn:"Go Premium+", examplesTitle:"Some example questions:", suggestion:"Suggestion", coffreErrFormat:"Unsupported format — use a photo (JPG, PNG) or a PDF.", coffreErrSize:"File too large — maximum 5 MB.", coffreErrStorage:"Storage full on this device. Delete an existing document before adding a new one.", leadFreeShort:"🌿 Lead-free", leadShort:"Lead", compareIntro:"Compare the trajectory of several ammunitions of the same caliber.", compareMax3:"Up to 3 ammunitions.", compareFree:"Free version: 2 ammunitions (3 in Premium).", chartLegend:"Values in cm vs line of sight", chartDelta:" · Δ = difference between the two", fusilRec:"🔫 Recommended shotguns", aiDeepBtn:"🤖 In-depth AI analysis — personalized advice", clearConv:"✕ Clear conversation",
...
const TIER_MODAL_I18N = {
  fr: {
    ...
    freeNote: "Gratuit : 3 questions IA / jour, fonctions de base.",
    premiumName: "Premium",
    premiumFeatures: ["Carnet de chasse numérique", "Coffre-fort numérique (documents)", "Distances et DRO personnalisées sans restriction", "Comparateur jusqu'à 3 munitions, multi-gibier", "Assistant IA + conseils calibre/munition — 100 crédits IA / mois sur Claude Sonnet"],
    premiumCta: "Choisir Premium",
    currentBadge: "Niveau actuel",
    plusUpgradeCta: "Passer à Premium+",
    plusName: "Premium+",
    plusFeatures: ["Tout ce qui est inclus dans Premium", "150 crédits IA / mois au lieu de 100", "Réponses sur Claude Opus — analyses plus approfondies"],
  ...
  nl: {
    ...
    freeNote: "Gratis: 3 AI-vragen / dag, basisfuncties.",
    premiumName: "Premium",
    premiumFeatures: ["Digitaal jachtlogboek", "Digitale kluis (documenten)", "Vrije afstand en DRO zonder beperking", "Vergelijk tot 3 munities, meerdere soorten wild", "AI-assistent + kaliber-/munitieadvies — 100 AI-credits / maand op Claude Sonnet"],
    premiumCta: "Kies Premium",
    currentBadge: "Huidig niveau",
    plusUpgradeCta: "Upgraden naar Premium+",
    plusName: "Premium+",
    plusFeatures: ["Alles wat in Premium is inbegrepen", "150 AI-credits / maand in plaats van 100", "Antwoorden op Claude Opus — diepgaandere analyses"],
  ...
  de: {
    ...
    freeNote: "Kostenlos: 3 KI-Fragen / Tag, Basisfunktionen.",
    premiumName: "Premium",
    premiumFeatures: ["Digitales Jagdbuch", "Digitaler Tresor (Dokumente)", "Freie Entfernung und DRO ohne Einschränkung", "Vergleich von bis zu 3 Munitionen, mehrere Wildarten", "KI-Assistent + Kaliber-/Munitionsberatung — 100 KI-Credits / Monat auf Claude Sonnet"],
    premiumCta: "Premium wählen",
    currentBadge: "Aktuelle Stufe",
    plusUpgradeCta: "Auf Premium+ upgraden",
    plusName: "Premium+",
    plusFeatures: ["Alles, was in Premium enthalten ist", "150 KI-Credits / Monat statt 100", "Antworten auf Claude Opus — vertiefte Analysen"],
  ...
  en: {
    ...
    freeNote: "Free: 3 AI questions / day, basic features.",
    premiumName: "Premium",
    premiumFeatures: ["Digital hunting logbook", "Digital safe (documents)", "Free distance and zero-point range, no restriction", "Compare up to 3 ammunitions, multi-species", "AI assistant + caliber/ammunition advice — 100 AI credits / month on Claude Sonnet"],
    premiumCta: "Choose Premium",
    currentBadge: "Current tier",
    plusUpgradeCta: "Upgrade to Premium+",
    plusName: "Premium+",
    plusFeatures: ["Everything included in Premium", "150 AI credits / month instead of 100", "Answers on Claude Opus — more in-depth analysis"],
...
export default function ChassIA() {
  ...
  const PREMIUM_CAP = 100;       // Premium (Sonnet)
  ...
  async function conseillerCalibre() {
    ...
    try {
      const resp = await askClaude(prompt, T.system, [], isPremiumPlus);
  ...
  async function poserQuestion() {
    ...
    // Garde-fou technique Premium : quota partagé (100/150 questions/mois selon tier, toutes fonctions IA confondues)
    if (isPremium) {
    ...
    try {
      const resp = await askClaude(q, T.system, apiHistory, isPremiumPlus);
                  ...
                  <div>
                    ...
                    <div>
                        ...
                        <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color: COLORS.textDim, marginTop:3 }}>
                          {gibierCMulti.length}/{isPremium ? 5 : 1} sélectionné{gibierCMulti.length>1?"s":""}
                        </div>
                      </div>
                  </div>
                  <div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                      <div>
                        ...
                        <div>
                            ...
                            <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color: COLORS.textDim, marginTop:3 }}>
                              {gibierMMulti.length}/{isPremium ? 5 : 1} sélectionné{gibierMMulti.length>1?"s":""}
                            </div>
                          </div>
                      </div>
                      <div>
                      ...
                      <div style={card}>
                        ...
                        <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                          {[
                            ...
                            <div key={key}>
                              ...
                              {type === "select" ? (
                                ...
                                <input type={type} value={carnetDraft[key]||""} maxLength={type === "text" ? 200 : undefined} onChange={e => setCarnetDraft(d=>({...d,[key]:e.target.value}))} style={fieldStyle}/>
                              )}
                            </div>
                          ))}
                          ...
                          <div>
                            ...
                            <textarea value={carnetDraft.notes||""} onChange={e => setCarnetDraft(d=>({...d,notes:e.target.value}))} rows={3} maxLength={1000} style={{...fieldStyle, resize:"vertical"}} placeholder={CN.notesPlaceholder}/>
                          </div>
                        </div>
      ...
      {showTierModal && (() => {
        ...
        return (
          <div onClick={() => setShowTierModal(false)} style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.7)", zIndex:1000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 }}>
            <div onClick={e => e.stopPropagation()} style={{ background:COLORS.bg, border:`1px solid ${COLORS.border}`, borderRadius:12, padding:"24px 22px", maxWidth:480, width:"100%", maxHeight:"90vh", overflowY:"auto" }}>
