        ...
        <div style={{ maxWidth: 700, margin: "0 auto", padding: "20px 24px 0" }}>
                ...
                return (
                  <div>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{ background:"#1a1a00", border:"1px solid #b8860b40", borderRadius:8, padding:"10px 14px", marginBottom:16, display:"flex", alignItems:"flex-start", gap:10 }}>
                          <span style={{ fontSize:14, flexShrink:0 }}>⚠️</span>
                          <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:10, color:"#b8860b", lineHeight:1.6 }}>
          ...
          {tab === "coffre" && (
            <div className="fade-in">
              ...
              <div style={{ background:"#1a1a00", border:"1px solid #b8860b40", borderRadius:8, padding:"10px 14px", marginBottom:20, display:"flex", alignItems:"flex-start", gap:10 }}>
                <span style={{ fontSize:14, flexShrink:0 }}>⚠️</span>
                <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:10, color:"#b8860b", lineHeight:1.6 }}>
                ...
                <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.92)", zIndex:1000, display:"flex", flexDirection:"column" }}
                  ...
                  <div style={{ flex:1, overflow:"auto", display:"flex", justifyContent:"center", alignItems:"flex-start", padding:16 }}
                    ...
                    {coffreViewer.type === "application/pdf" ? (
                      <iframe src={coffreViewer.data} style={{ width:"100%", minHeight:"85vh", height:"85vh", border:"none", borderRadius:8 }} title={coffreViewer.name} />
                    ) : (
                      <img src={coffreViewer.data} alt={coffreViewer.name} style={{ width:"100%", height:"auto", borderRadius:8, display:"block" }} />
                    )}
                  </div>
                </div>
              )}
