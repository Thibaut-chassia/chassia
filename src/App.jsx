...
const CARNET_I18N = {
  fr: {
    ...
    backupWarn:"Vos données sont sauvegardées sur cet appareil uniquement. Si vous changez d'appareil ou videz votre navigateur, elles seront perdues. Synchronisation cloud disponible en Premium+.", backupSynced:"Tes données sont synchronisées avec ton compte — accessibles sur tous tes appareils connectés.",
  ...
  nl: {
    ...
    backupWarn:"Je gegevens worden enkel op dit toestel opgeslagen. Als je van toestel verandert of je browser wist, gaan ze verloren. Cloudsynchronisatie beschikbaar in Premium+.", backupSynced:"Je gegevens zijn gesynchroniseerd met je account — toegankelijk op al je verbonden toestellen.",
  ...
  de: {
    ...
    backupWarn:"Ihre Daten werden nur auf diesem Gerät gespeichert. Wenn Sie das Gerät wechseln oder den Browser leeren, gehen sie verloren. Cloud-Synchronisierung verfügbar in Premium+.", backupSynced:"Ihre Daten sind mit Ihrem Konto synchronisiert — auf allen verbundenen Geräten verfügbar.",
  ...
  en: {
    ...
    backupWarn:"Your data is saved on this device only. If you change device or clear your browser, it will be lost. Cloud sync available in Premium+.", backupSynced:"Your data is synced with your account — accessible on all your connected devices.",
...
const COFFRE_I18N = {
  fr: {
    ...
    banner:"Vos documents sont sauvegardés sur cet appareil uniquement. Si vous changez d'appareil ou videz votre navigateur, ils seront perdus. Synchronisation cloud disponible en Premium+.", bannerSynced:"Tes documents sont synchronisés avec ton compte — accessibles sur tous tes appareils connectés.",
  ...
  nl: {
    ...
    banner:"Je documenten worden enkel op dit toestel opgeslagen. Als je van toestel verandert of je browser wist, gaan ze verloren. Cloudsynchronisatie beschikbaar in Premium+.", bannerSynced:"Je documenten zijn gesynchroniseerd met je account — toegankelijk op al je verbonden toestellen.",
  ...
  de: {
    ...
    banner:"Ihre Dokumente werden nur auf diesem Gerät gespeichert. Wenn Sie das Gerät wechseln oder den Browser leeren, gehen sie verloren. Cloud-Synchronisierung verfügbar in Premium+.", bannerSynced:"Ihre Dokumente sind mit Ihrem Konto synchronisiert — auf allen verbundenen Geräten verfügbar.",
  ...
  en: {
    ...
    banner:"Your documents are saved on this device only. If you change device or clear your browser, they will be lost. Cloud sync available in Premium+.", bannerSynced:"Your documents are synced with your account — accessible on all your connected devices.",
...
const TIER_MODAL_I18N = {
  fr: {
    title: "Choisis ton niveau Premium", alreadyMember: "Déjà Premium ? Se connecter avec Google",
    subtitle: "Premium+ inclut tout Premium, avec plus de crédits IA, Claude Opus, et des fonctions exclusives (photos, équipement, synchronisation cloud).",
    ...
    plusName: "Premium+",
    plusFeatures: ["Tout ce qui est inclus dans Premium", "Comparateur jusqu'à 4 munitions (3 en Premium)", "Rapport de saison PDF (statistiques + détail des prélèvements)", "Photos dans le Carnet — jusqu'à 3 par prise", "Fiche équipement dans le Coffre — armes, munition, optique", "150 crédits IA / mois au lieu de 75", "Réponses sur Claude Opus — analyses plus approfondies", "Synchronisation cloud entre tes appareils"],
    close: "Fermer",
  },
  nl: {
    title: "Kies je Premium-niveau", alreadyMember: "Al Premium? Inloggen met Google",
    subtitle: "Premium+ omvat alles van Premium, met meer AI-credits, Claude Opus, en exclusieve functies (foto's, uitrusting, cloudsynchronisatie).",
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles wat in Premium is inbegrepen", "Vergelijker tot 4 munities (3 in Premium)", "PDF-seizoensrapport (statistieken + detail van de vangsten)", "Foto's in het Logboek — tot 3 per vangst", "Uitrusting in de Kluis — wapens, munitie, optiek", "150 AI-credits / maand in plaats van 75", "Antwoorden op Claude Opus — diepgaandere analyses", "Cloudsynchronisatie tussen je toestellen"],
    close: "Sluiten",
  },
  de: {
    title: "Wähle deine Premium-Stufe", alreadyMember: "Schon Premium? Mit Google anmelden",
    subtitle: "Premium+ enthält alles aus Premium, mit mehr KI-Credits, Claude Opus, und exklusiven Funktionen (Fotos, Ausrüstung, Cloud-Synchronisierung).",
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles, was in Premium enthalten ist", "Vergleich mit bis zu 4 Munitionen (3 in Premium)", "Saisonbericht PDF (Statistiken + Detail der Abschüsse)", "Fotos im Jagdbuch — bis zu 3 pro Abschuss", "Ausrüstungsliste im Tresor — Waffen, Munition, Optik", "150 KI-Credits / Monat statt 75", "Antworten auf Claude Opus — vertiefte Analysen", "Cloud-Synchronisierung zwischen deinen Geräten"],
    close: "Schließen",
  },
  en: {
    title: "Choose your Premium tier", alreadyMember: "Already Premium? Sign in with Google",
    subtitle: "Premium+ includes everything in Premium, with more AI credits, Claude Opus, and exclusive features (photos, equipment, cloud sync).",
    ...
    plusName: "Premium+",
    plusFeatures: ["Everything included in Premium", "Comparator with up to 4 ammunitions (3 in Premium)", "Season report PDF (statistics + detailed harvest log)", "Photos in the Logbook — up to 3 per entry", "Equipment list in the Safe — weapons, ammunition, optics", "150 AI credits / month instead of 75", "Answers on Claude Opus — more in-depth analysis", "Cloud sync across your devices"],
    close: "Close",
  },
};
...
export default function ChassIA() {
  ...
  // ── SUPABASE AUTH (sync cloud Premium+) ──────────────────────────────────
  ...
  const uploadDoc = (id, file) => {
    ...
    const store = (data, type) => {
      ...
      const cloudEligible = session && isPremiumPlus;
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      setProfileTier(data.tier === "premium_plus" ? "premiumPlus" : data.tier);
  ...
  const [redeemCodePremium, setRedeemCodePremium] = useState("");
  const [redeemCodePlus, setRedeemCodePlus] = useState("");
  ...
  const isPremium = !!effectiveTier && effectiveTier !== "free"; // déverrouille les fonctions payantes (Premium + Premium+)
  const isPremiumPlus = effectiveTier === "premiumPlus"; // déverrouille le modèle Opus
  // Plafond de crédits selon le palier réel (une fois connecté) — sert à l'affichage
  // du compteur ; le serveur applique son propre plafond de façon indépendante.
  const creditsCap = effectiveTier === "premiumPlus" ? 150 : effectiveTier === "premium" ? 75 : null;
  ...
  // ── SYNC CLOUD : ÉQUIPEMENT (Premium+ connecté) ──────────────────────────
  ...
  useEffect(() => {
    if (!(session && isPremiumPlus)) return;
    let cancelled = false;
    (async () => {
    ...
    return () => { cancelled = true; };
  }, [userId, isPremiumPlus]);

  // ── SYNC CLOUD : CARNET (Premium+ connecté) ──────────────────────────────
  ...
  // ── SYNC CLOUD : DOCUMENTS DU COFFRE (Premium+ connecté) ─────────────────
  ...
  async function conseillerCalibre() {
    ...
    try {
      const resp = await askClaude(prompt, T.system, [], isPremiumPlus, UIX.aiTimeout, UIX.aiOffline, session?.access_token, updateCreditsDisplay);
  ...
  async function poserQuestion() {
    ...
    try {
      const resp = await askClaude(q, T.system, apiHistory, isPremiumPlus, UIX.aiTimeout, UIX.aiOffline, session?.access_token, updateCreditsDisplay);
                ...
                return (
                  <div className="fade-in">
                    ...
                    <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:16 }}>
                      ...
                      {isPremium ? (
                        <div>
                            <label style={{...fieldLabel, color:COLORS.compare3}}>● {UIX.munition} 3 <span style={{fontSize:9, color:COLORS.accent}}>Premium</span></label>
                      ...
                      {isPremiumPlus ? (
                        <div>
                            <label style={{...fieldLabel, color:COLORS.compare4}}>● {UIX.munition} 4 <span style={{fontSize:9, color:COLORS.accent}}>Premium+</span></label>
                  ...
                  {isPremium && (
                    <div style={{ display:"flex", flexDirection:"column", gap:4 }}>
                      <div style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize: 11, color: COLORS.accent }}>
                        🌿 {isPremiumPlus ? "PREMIUM+" : "PREMIUM"} — {creditsUsed != null ? `${creditsUsed}/${currentQuotaCap}` : currentQuotaCap} {UIX.creditsLabel}
                      </div>
          ...
          {tab === "carnet" && (
            <div className="fade-in">
              {!isPremium ? (
                ...
                return (
                  <div>
                    {isPremium && <SyncBanner session={session} onSignIn={signInWithGoogle} onSignOut={signOutSupabase} texts={UIX} creditsUsed={creditsUsed} creditsCap={creditsCap} />}
                    {/* Header */}
          ...
          {tab === "coffre" && (
            <div className="fade-in">
              ...
              <p style={{ color:COLORS.textMuted, fontStyle:"italic", marginBottom:16, fontSize:"0.95rem" }}>
                {(session && isPremiumPlus) ? CF.introSynced : CF.intro}
              </p>
            ...
            <div onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-label={TM.title} style={{ background:COLORS.bg, border:`1px solid ${COLORS.border}`, borderRadius:12, padding:"24px 22px", maxWidth:480, width:"100%", maxHeight:"90vh", overflowY:"auto" }}>
              ...
              {!session ? (
                <button onClick={signInWithGoogle}
                  style={{ display:"block", width:"100%", background:"transparent", border:`1px solid ${COLORS.border}`, borderRadius:6, color:COLORS.textMuted, padding:"8px 14px", fontFamily:"'IBM Plex Mono',monospace", fontSize:12, cursor:"pointer", marginBottom:18, textAlign:"center" }}>
                  {TM.alreadyMember}
                </button>
              ) : (
                // Un compte peut être connecté SANS palier payant (aucun code activé).
                // Sans ce bloc, il n'aurait aucun moyen de se déconnecter : le seul
                // autre bouton de déconnexion vit dans Carnet/Coffre, deux onglets
                // justement verrouillés tant qu'on n'est pas Premium.
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:10, flexWrap:"wrap", marginBottom:18, fontFamily:"'IBM Plex Mono',monospace", fontSize:11, color:COLORS.textMuted }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                {/* Carte Premium */}
                <div style={{ border:`1px solid ${effectiveTier === "premium" ? COLORS.accent : COLORS.border}`, borderRadius:10, padding:"16px 16px" }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:10 }}>
                    ...
                    {effectiveTier === "premium" && <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color:COLORS.onAccent, background:COLORS.accent, borderRadius:4, padding:"2px 8px" }}>{TM.currentBadge}</span>}
                  </div>
                  ...
                  {!isPremium && (
                    <div style={{ display:"flex", gap:8, marginTop:14 }}>
                      <input type="text" value={redeemCodePremium} onChange={e => setRedeemCodePremium(e.target.value)} placeholder={UIX.redeemPlaceholder}
                        style={{ flex:1, minWidth:0, background:COLORS.bgCard, border:`1px solid ${COLORS.border}`, borderRadius:6, padding:"8px 10px", color:COLORS.white, fontFamily:"'IBM Plex Mono',monospace", fontSize:13 }} />
                      <button onClick={() => activateCode(redeemCodePremium, setRedeemCodePremium)} disabled={redeemStatus === "loading" || !redeemCodePremium.trim()}
                        style={{ background:"transparent", color:COLORS.accent, border:`1px solid ${COLORS.accent}`, borderRadius:6, padding:"8px 14px", fontFamily:"'IBM Plex Mono',monospace", fontSize:12, fontWeight:700, cursor:"pointer", flexShrink:0, opacity:(redeemStatus === "loading" || !redeemCodePremium.trim()) ? 0.6 : 1 }}>
                        {UIX.redeemBtn}
                      </button>
                    </div>
                  )}
                ...
                <div style={{ border:`1px solid ${COLORS.accent}`, borderRadius:10, padding:"16px 16px", background:COLORS.accentGlow }}>
                  ...
                  {!isPremiumPlus && (
                    <div style={{ display:"flex", gap:8, marginTop:14 }}>
                      <input type="text" value={redeemCodePlus} onChange={e => setRedeemCodePlus(e.target.value)} placeholder={UIX.redeemPlaceholder}
                        style={{ flex:1, minWidth:0, background:COLORS.bgCard, border:`1px solid ${COLORS.border}`, borderRadius:6, padding:"8px 10px", color:COLORS.white, fontFamily:"'IBM Plex Mono',monospace", fontSize:13 }} />
                      <button onClick={() => activateCode(redeemCodePlus, setRedeemCodePlus)} disabled={redeemStatus === "loading" || !redeemCodePlus.trim()}
                        style={{ background:COLORS.accent, color:COLORS.onAccent, border:"none", borderRadius:6, padding:"8px 14px", fontFamily:"'IBM Plex Mono',monospace", fontSize:12, fontWeight:700, cursor:"pointer", flexShrink:0, opacity:(redeemStatus === "loading" || !redeemCodePlus.trim()) ? 0.6 : 1 }}>
                        {UIX.redeemBtn}
                      </button>
                    </div>
                  )}
