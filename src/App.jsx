...
const LANGS = {
  fr: {
    ...
    limitText:"Tu as utilisé ta question gratuite du jour. Connecte-toi avec ton code d'accès pour 150 questions par mois.",
    ...
    freeNote:"Visiteur : 1 question / jour · 150 par mois pour les membres",
  ...
  nl: {
    ...
    limitText:"Je hebt je gratis vraag van vandaag gebruikt. Log in met je toegangscode voor 150 vragen per maand.",
    assistPH:"Stel je vraag over de jacht in België… (Enter om te verzenden)",
    assistLimitPH:"Daglimiet bereikt — log in",
    freeNote:"Bezoeker: 1 vraag/dag · 150 per maand voor leden",
  ...
  de: {
    ...
    limitText:"Sie haben Ihre kostenlose Frage für heute verbraucht. Melden Sie sich mit Ihrem Zugangscode an für 150 Fragen pro Monat.",
    assistPH:"Stellen Sie Ihre Frage zur Jagd in Belgien… (Enter zum Senden)",
    assistLimitPH:"Tageslimit erreicht — anmelden",
    freeNote:"Besucher: 1 Frage/Tag · 150 pro Monat für Mitglieder",
  ...
  en: {
    ...
    limitText:"You have used your free question for today. Sign in with your access code for 150 questions per month.",
    assistPH:"Ask your question about hunting in Belgium… (Enter to send)",
    assistLimitPH:"Daily limit reached — sign in",
    freeNote:"Visitor: 1 question/day · 150 per month for members",
...
const TIER_MODAL_I18N = {
  ...
  nl: {
    ...
    memberName: "Lid",
    memberFeatures: ["Alles wat een bezoeker heeft", "Jachtlogboek — inclusief foto's, tot 3 per vangst", "Kluis — documenten en uitrustingsfiche", "Vergelijker tot 4 munities", "Seizoensrapport in PDF", "150 vragen per maand aan de AI-assistent", "Antwoorden via Claude Opus — diepgaandere analyses", "Synchronisatie tussen al je toestellen"],
  ...
  de: {
    ...
    memberName: "Mitglied",
    memberFeatures: ["Alles, was ein Besucher hat", "Jagdbuch — mit Fotos, bis zu 3 pro Abschuss", "Tresor — Dokumente und Ausrüstungsliste", "Vergleich von bis zu 4 Munitionen", "Saisonbericht als PDF", "150 Fragen pro Monat an den KI-Assistenten", "Antworten über Claude Opus — tiefergehende Analysen", "Synchronisierung zwischen all Ihren Geräten"],
  ...
  en: {
    ...
    memberName: "Member",
    memberFeatures: ["Everything a visitor gets", "Hunting logbook — photos included, up to 3 per entry", "Safe — documents and equipment list", "Compare up to 4 ammunitions", "Season report as PDF", "150 questions per month to the AI assistant", "Answers on Claude Opus — deeper analysis", "Sync across all your devices"],
