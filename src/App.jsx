...
const MUNITIONS_DATA = {
  ...
  "7mm Rem Mag": [
    ...
    { label: "Norma Ecostrike 9,1g 🌿",        marque:"Norma", sansPlomb:true,  v0:910,  poids:9.1 },
    { label: "Hornady SST Superformance 154gr", marque:"Hornady", sansPlomb:false, v0:945, poids:10 },
  ...
  ".338 Win Mag": [
    ...
    { label: "Hornady SST Superformance 225gr", marque:"Hornady", sansPlomb:false, v0:866, poids:14.6 },
  ],
  ".338 Lapua Mag": [
                      ...
                      <div style={card}>
                        ...
                        <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                          ...
                          <div>
                            ...
                            <input type="range" min="1" max="5" value={carnetDraft.emotion||3} onChange={e => setCarnetDraft(d=>({...d, emotion:parseInt(e.target.value, 10)}))} style={{ width:"100%", accentColor:COLORS.accent }}/>
                          ...
                          <div>
                            ...
                            <input type="range" min="1" max="5" value={carnetDraft.difficulte||3} onChange={e => setCarnetDraft(d=>({...d, difficulte:parseInt(e.target.value, 10)}))} style={{ width:"100%", accentColor:COLORS.accent }}/>
                            <div style={{ display:"flex", justifyContent:"space-between", fontFamily:"'IBM Plex Mono',monospace", fontSize:9, color:COLORS.textMuted, marginTop:2 }}>
