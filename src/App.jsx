...
const TIER_MODAL_I18N = {
  fr: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Tout ce qui est inclus dans Premium", "Comparateur jusqu'à 4 munitions (3 en Premium)", "Rapport de saison PDF (statistiques + détail des prélèvements)", "Munitions favorites — accès rapide dans toute l'app", "150 crédits IA / mois au lieu de 100", "Réponses sur Claude Opus — analyses plus approfondies"],
  ...
  nl: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles wat in Premium is inbegrepen", "Vergelijker tot 4 munities (3 in Premium)", "PDF-seizoensrapport (statistieken + detail van de vangsten)", "Favoriete munities — snelle toegang in de hele app", "150 AI-credits / maand in plaats van 100", "Antwoorden op Claude Opus — diepgaandere analyses"],
  ...
  de: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Alles, was in Premium enthalten ist", "Vergleich mit bis zu 4 Munitionen (3 in Premium)", "Saisonbericht PDF (Statistiken + Detail der Abschüsse)", "Lieblingsmunition — schneller Zugriff in der ganzen App", "150 KI-Credits / Monat statt 100", "Antworten auf Claude Opus — vertiefte Analysen"],
  ...
  en: {
    ...
    plusName: "Premium+",
    plusFeatures: ["Everything included in Premium", "Comparator with up to 4 ammunitions (3 in Premium)", "Season report PDF (statistics + detailed harvest log)", "Favorite ammunitions — quick access throughout the app", "150 AI credits / month instead of 100", "Answers on Claude Opus — more in-depth analysis"],
