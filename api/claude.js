...
// ── Réglages (ajustables) ──────────────────────────────────────────────────
const ALLOWED_ORIGIN     = 'https://chassia.be';                  // les appels de l'app sont same-origin → non affectés
...
export default async function handler(req, res) {
  // CORS restreint (l'app appelle /api/claude en relatif → same-origin, donc non bloquée).
